  ...
  <div class="screen">
    ...
    <div class="card">
      ...
      <p style="font-size:11px;color:var(--muted);margin:6px 2px 0;line-height:1.7;">
        بتشمل: تذكير قبل كل حصة، تذكير لو لسه ما ذاكرتش الساعة 8 بالليل، تذكير بالمراجعات المستحقة الساعة 5، تذكير امتحان الجمعة الساعة 10 صباحًا، وتهنئة عند تحقيق هدفك اليومي.
      </p>
